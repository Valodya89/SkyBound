...
struct ShareCardView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 0) {
                Text("Starlane").capsLabel(14, color: .white.opacity(0.85), tracking: 6).padding(.top, 48)
                HStack(spacing: 10) {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                HStack(spacing: 10) {
                    ShareLink(item: Image(uiImage: image), preview: SharePreview("Starlane run card", image: Image(uiImage: image))) {
