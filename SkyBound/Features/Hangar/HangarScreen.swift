...
private struct WorkshopSection: View {
    ...
    var body: some View {
        ...
        SectionRule("Energy")
        let capMaxed = p.maxEnergy >= EnergySystem.maxCap
        ItemRow(symbol: "bolt", tint: Theme.flare, title: "Energy cap +1", subtitle: "Now \(p.maxEnergy) · hard cap \(EnergySystem.maxCap)") {
